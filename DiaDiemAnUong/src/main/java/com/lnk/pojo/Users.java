...
public class Users implements Serializable {
    ...
    @Size(min = 1, max = 50 ,message = "{users.name.lenErr}")
    @Column(name = "username")
    private String username;
    @Basic(optional = false)
    @NotNull (message = "{pass.name.notNull}")
    @Size(min = 1, max = 100 , message = "{pass.name.lenErr}")
    ...
    @Basic(optional = false)
    @NotNull (message ="{confirm.name.notNull}")
